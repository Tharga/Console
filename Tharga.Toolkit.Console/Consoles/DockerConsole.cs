...
{
    public class DockerConsole : ConsoleBase
    {
        public DockerConsole(IConsoleConfiguration consoleConfiguration = null)
            : base(new OutputConsoleManager(System.Console.Out))
        {
